...
FIELDS: tuple[ConfigFieldSpec, ...] = (
    ...
    ConfigFieldSpec(
        ...
        secret=True,
        description="Optional API key for generic OpenAI-compatible custom provider.",
    ),
    ConfigFieldSpec(
        ...
        description="OpenAI-compatible base URL, for example https://api.openai.com/v1 or your gateway URL.",
    ),
    ConfigFieldSpec(
        "LM_STUDIO_BASE_URL",
        "LM Studio Base URL",
